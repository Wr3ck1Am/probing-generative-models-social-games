...
\begin{figure}[t]
    ...
    \caption{Crewmate and Impostor win rates across four configurations with 95\% confidence intervals. Sample sizes: All-Random ($N{=}10$), All-LLM ($N{=}14$), LLM-Crew ($N{=}14$), LLM-Impostor ($N{=}15$). The dashed line marks 50\%.}
    \label{fig:winrates}
\end{figure}
